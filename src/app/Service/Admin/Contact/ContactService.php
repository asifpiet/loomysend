...
{ 
    ...
    public function getAllInactiveContacts($user_id = null) {
    ...
    public function getAllOptOutContacts($user_id = null) {
    ...
    public function undo($id) {
            ...
            $status  = true;
            $reload  = false;
            $message = translate('Contact Active successfully');
            $contact = Contact::where("id", $id)->first();
            
            if($contact->status == StatusEnum::FALSE->status()) {
             ...
             list($status, $message) = [$status, $message];
             $notify[] = [$status, $message];
                return $notify;
