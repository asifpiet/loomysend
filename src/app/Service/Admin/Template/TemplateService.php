...
class TemplateService
{
    ...
    public function save($data, $request, $user_id = null) {
        ...
        $data['status'] = StatusEnum::TRUE->status();
    ...
    public function statusUpdate($request) {
        ...
        try {
            ...
            $flag     = true;
            if($template->provider == TemplateProvider::BEE_FREE->value) {
                ...
                if(
                    ...
                    $message = translate('Plugin not available cannot update template status');
                    $status  = false;
                    $flag    = false;
                    $reload  = true;
                }
