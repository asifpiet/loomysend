...
class CampaignController extends Controller
{
    ...
    // dd($selectedGateway);
       return view('admin.communication.sms.campaign.edit', compact('title', 'groups', 'type', 'templates', 'api_gateways', 'android_gateways', 'selectedGateway', 'selectedGroups', 'campaign'));
    }
    ...
    public function editEmail($id) {
        ...
        // dd($campaign);
        return view('admin.communication.email.campaign.edit', compact('title', 'groups', 'type', 'templates', 'selectedRepeatFormat', 'selectedGateway', 'selectedGroups', 'gateways', 'campaign'));
    }
