...
class ContactGroupController extends Controller
{
    ...
    public function index($id = null):View {
        ...
        $contact_groups = $id ? $this->contactGroupService->getGroupWithChild($id) : $this->contactGroupService->getAllGroups(); 
        return view('admin.contact.groups.index', compact('title', 'contact_groups'));
    }
    ...
    public function save(ContactGroupRequest $request) {
        ...
        $data = $this->contactGroupService->updateOrCreate($data);
    ...
    public function html($id) {
        ...
        try {
            ...
            return view('admin.contact.groups.html', compact('title', 'group'));
        } catch (\Exception $e) {
               $status  = 'error';
                $message = translate("Server Error");
                // Alert::error(translate('Whoops'), translate('List Not Exist'));
     ...
     public function download($id)
    {
        ...
        $filePath = storage_path('app/public/groups/' . $group->file_name.'.html');
        // dd($filePath);
