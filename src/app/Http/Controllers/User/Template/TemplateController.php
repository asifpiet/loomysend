...
class TemplateController extends Controller
{
    ...
    public function save(TemplateRequest $request) {
        ...
        try {
			...
			if($data && $data['template_data']['mail_body']){
			    $data['template_html'] = $data['template_data']['mail_body'];
			    $data['template_data']['mail_body'] = '';
			}
            ...
            $status   = 'success';
            $message  = ucfirst(ServiceType::getValue($template->type)). ' template has been created.';
