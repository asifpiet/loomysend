...
class HomeController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $credits = CreditLog::where('user_id', $user->id)->with('user')->where('credit', '!=', '0')->orderBy('id', 'DESC')->take(site_settings("paginate_number"))->get();
        ...
        $logs = [
            "sms" => [
                ...
                'allsmsCamapgin' => Campaign::where('type', ServiceType::SMS->value)->where('user_id', $user->id)->count(),
                ...
                'currentMonthTotalSentSMS' => CommunicationLog::where('type', ServiceType::SMS->value)->where('user_id', $user->id)->whereMonth('created_at', $currentMonth)->count(),
                'lastMonthTotalSentSMS' => CommunicationLog::where('type', ServiceType::SMS->value)->where('user_id', $user->id)->whereMonth('created_at', $lastMonth)->count(),
                'lasttwoMonthTotalSentSMS' => CommunicationLog::where('type', ServiceType::SMS->value)->where('user_id', $user->id)->whereMonth('created_at', $twoMonthsAgo)->count()
            ],
            "email" => [
                'all' => CommunicationLog::where('type', ServiceType::EMAIL->value)->where('user_id', $user->id)->count(),
                'allemailCampaign' => Campaign::where('type', ServiceType::EMAIL->value)->where('user_id', $user->id)->count(),
                'success' => CommunicationLog::where('type', ServiceType::EMAIL->value)->whereNotNull('campaign_id')->where('user_id', $user->id)->where('status', CommunicationStatusEnum::DELIVERED->value)->count(),
                ...
                'recipients' => CommunicationLog::where('type', ServiceType::EMAIL->value)->where('user_id', $user->id)->whereNotNull('campaign_id')->whereNotNull('contact_id')->count('contact_id'),
                'opens'     => CommunicationLog::where('type', ServiceType::EMAIL->value)->where('user_id', $user->id)->whereNotNull('campaign_id')->where('unique_clicks', '>', 0)->sum('unique_clicks'),
                'clicks'    => CommunicationLog::where('type', ServiceType::EMAIL->value)->where('user_id', $user->id)->whereNotNull('campaign_id')->where('unique_clicks', '>', 0)->count(),
                'currentMonthTotalSentmail' => CommunicationLog::where('type', ServiceType::EMAIL->value)->where('user_id', $user->id)->whereMonth('created_at', $currentMonth)->count(),
                'lastMonthTotalSentmail' => CommunicationLog::where('type', ServiceType::EMAIL->value)->where('user_id', $user->id)->whereMonth('created_at', $lastMonth)->count(),
                'lasttwoMonthTotalSentmail' => CommunicationLog::where('type', ServiceType::EMAIL->value)->where('user_id', $user->id)->whereMonth('created_at', $twoMonthsAgo)->count()
            ],
            'whats_app' => [
        ...
        return view('user.dashboard', compact('title', 'currentMonthName',
            'lastMonthName',
            'twoMonthsAgoName',
            'user', 'transactions', 'credits', 'logs'));
    }
