...
class CampaignController extends Controller
{
    ...
    public function __construct() {
        ...
        $this->campaignService = new CampaignService($this->smsService, $this->emailService, $this->whatsappService, $this->contactGroupService, $this->smsGatewayService, $this->whatsappGatewayService, $this->emailGatewayService);
    }
    ...
    public function createEmail() {
        ...
        return view('user.communication.email.campaign.create', compact('title', 'groups', 'type', 'templates', 'gateways'));
    }
    ...
    public function editSms($id) {
        ...
        $selectedGateway = $metaDataArry['gateway'];
        
        // dd($selectedGateway);
        return view('user.communication.sms.campaign.edit', compact('title', 'groups', 'type', 'remaining_credit', 'plan_access', 'templates', 'api_gateways', 'android_gateways', 'selectedGateway', 'selectedGroups', 'campaign'));
    }
    ...
    public function editEmail($id) {
        ...
        $selectedGroups = $metaDataArry['contact']['group_ids'];
        $selectedGateway = $metaDataArry['gateway'];
        $selectedRepeatFormat = $campaign->repeat_format;
        
        
        return view('user.communication.email.campaign.edit', compact('title', 'groups',  'selectedGateway', 'selectedRepeatFormat', 'selectedGroups', 'type', 'templates', 'gateways', 'campaign'));
    }
