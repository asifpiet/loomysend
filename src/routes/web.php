...
Route::get('/email/open/{tracking_id}', [CommunicationController::class, 'trackOpen'])->name('email.open');
// Route::post('save', 'save')->name('save');
Route::post('dsave', [TemplateController::class, 'save'])->name('dsave');
Route::get('/user-unsubscribe', [CommunicationController::class, 'unsubscribe']);
