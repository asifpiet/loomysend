        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <a href="{{ route('admin.communication.exportEmail', $user_id) }}" class="i-btn bg-danger btn--sm text-white">
                            Export Logs
                        </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column gap-1 align-items-start ">
                                            ...
                                            <span>
                                                {{ translate("Scheduled For: ") }}{{ $log->is_scheduled == 'yes' ? ($log->schedule_at ?? 'N/A') : 'N/A' }}
                                            </span>
