                    ...
                    <div class="form-element">
                        ...
                        <div class="col-xxl-8 col-lg-9">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap gap-2 mb-2">
                                ...
                                <label for="message" class="text-counter"><small>{{ translate("If your message is over 160 characters. Longer messages will be sent as multiple SMS segments, which may impact your costs.") }}</small></label>
                            ...
                            <div class="mt-3">
                                <div class="track-link-container">
                                    <div class="switch-wrapper checkbox-data">
                                        <input type="checkbox" class="switch-input" id="trackLinkCheckbox" name="is_default">
