        ...
        <div class="container-fluid px-0 main-content">
          ...
          <div class="card card-height-100">
            ...
            <div class="card-header">
              <h4 class="card-title">{{ translate("SMS Report") }}</h4>
            </div>
          </div>
            ...
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <div class="d-flex gap-3 align-item-center"> 
                        <a href="{{ route('admin.communication.export', $user_id) }}" class="i-btn bg-danger btn--sm text-white">
                            Export Logs
                        </a>
                       <!--<div class="d-flex align-items-center mb-2" style="font-size: 0.875rem;">-->
                       <!--     <label for="filterDropdown" class="me-2">Export:</label>-->
                       <!--     <select id="filterDropdown" class="form-select form-select-sm w-auto" style="padding: 0.25rem 1.5rem;">-->
                       <!--         <option value="all">All</option>-->
                       <!--         <option value="onlyClicks">Only Clicks</option>-->
                       <!--         <option value="nonClicks">Non Clicks</option>-->
                       <!--     </select>-->
                       <!-- </div>-->
                    ...
                    <table>
                        <thead>
                                <tr>
                                    ...
                                    <th scope="col">{{ translate("Clicked") }}</th>
