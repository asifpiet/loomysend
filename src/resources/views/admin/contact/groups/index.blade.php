    ...
    <div class="container-fluid px-0 main-content">
      ...
      <div class="card">
        ...
        <div class="card-body px-0 pt-0">
                ...
                @forelse($contact_groups as $contact_group)
                    <tr>
                        ...
                        <td data-label="{{ translate('Group')}}">
                            <a href="{{route('admin.contact.index', $contact_group->id)}}" class="badge badge--primary p-2">
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-1">
                                ...
                                <button class="icon-btn btn-ghost btn-sm danger-soft circle text-danger delete-contact-group"
                                 ...
                                 <a class="flex items-center text-theme-1 tooltip" href="{{ route('admin.contact.group.download', $contact_group->id ) }}" title="@translate(Download)">
                                    <i class="ri-download-line"></i>
                                    
                                     <a class="flex items-center mr-3 tooltip" title="@translate(Html)" href="{{ route('admin.contact.group.html', $contact_group->id ) }}">
          ...
          @include('admin.partials.pagination', ['paginator' => $contact_groups])
        </div>
      </div>
    </div>
</main>
...
<div class="modal fade" id="addContactGroup" tabindex="-1" aria-labelledby="addContactGroup" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered ">
        <div class="modal-content">
            <form action="{{route('admin.contact.group.save')}}" method="POST" enctype="multipart/form-data">
				@csrf
...
<div class="modal fade actionModal" id="deleteContactGroup" tabindex="-1" aria-labelledby="deleteContactGroup" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        ...
        <form action="{{route('admin.contact.group.delete')}}" method="POST">
            @csrf
...
<div class="modal fade actionModal" id="bulkAction" tabindex="-1" aria-labelledby="bulkAction" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        ...
        <form action="{{route('admin.contact.group.bulk')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
