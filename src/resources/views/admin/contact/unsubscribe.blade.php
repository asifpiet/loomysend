      ...
      <div class="card">
        <div class="card-header">
            <div class="card-header-left">
                <h4 class="card-title">{{ translate("Unsubscribe") }}</h4>
            </div>
              ...
              <tbody>
                @forelse($contacts as $contact)
                    <tr>
                        ...
                        <td>{{ $contact->status == 0 ? 'InActive': 'Active' }}</td>
                        <td data-label="{{ translate('Group')}}">
                            <a href="{{route('admin.contact.resubscribe', $contact->id)}}" class="badge badge--primary p-2">
                                Undo
                                </span>
                            </a>
                        </td>
