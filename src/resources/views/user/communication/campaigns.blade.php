                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th scope="col">{{ translate("Opt-outs") }}</th>
                        ...
                        @forelse($campaigns as $campaign)
                            ...
                            <tr>
                                ...
                                <td data-label="{{ translate('Contacts')}}">
                                    <a href="{{route("user.communication.$type.index", [ 'id' => $campaign->id])}}" class="badge badge--primary p-2">
                                        <span class="i-badge info-solid pill">
                                            <!--{{ translate('View all').' ('.$campaign->communicationlog->count().') ' }} <i class="ri-eye-line ms-1"></i>-->
                                             {{ translate('View all').' ('.getSMSCamapignContacts($campaign->id).') ' }} <i class="ri-eye-line ms-1"></i>
                                        </span>
                                    </a>
                                    
                                    <!--<a href="{{route("admin.communication.$type.index",  [ 'id' => $campaign->id] )}}" class="badge badge--primary p-2">-->
                                    <!--    <span class="i-badge info-solid pill">-->
                                    <!--        {{ translate('View all').' ('.getSMSCamapignContacts($campaign->id).') ' }} <i class="ri-eye-line ms-1"></i>-->
                                    <!--    </span>-->
                                ...
                                <td>{{ getSMSCamapignClicks($campaign->id) }}</td>
                                <td>
                                     <a class="i-badge info-solid pill" href="#">0</a>
                                     <!--<a class="i-badge info-solid pill" href="{{ route("admin.contact.opt-out") }}"></a>-->
                                 </td>
                                <td>
