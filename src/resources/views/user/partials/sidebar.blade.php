...
<aside class="sidebar">
    <div class="sidebar-wrapper">
        ...
        <div class="menu-wrapper">
                        ...
                        <div class="sub-menu-container">
                            ...
                            <ul class="sidebar-menu">
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{ request()->routeis('user.contact.group.index') ? 'active' : '' }}" href="{{ route('user.contact.group.index') }}" aria-expanded="false">
                                        <span>
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{ request()->routeis('user.contact.index') ? 'active' : '' }}" href="{{ route('user.contact.index') }}" aria-expanded="false">
                                        <span>
                                ...
                                <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-link {{ request()->routeis('user.contact.unsubscribe') ? 'active' : '' }}" href="{{ route('user.contact.unsubscribe') }}" aria-expanded="false">
                                            <span>
                                                <i class="ri-list-indefinite"></i>
                                            </span>
                                            <p>{{ translate("Unsubscribe") }}</p>
                                        </a>
                                        <a class="sidebar-menu-link {{ request()->routeis('user.contact.opt-out') ? 'active' : '' }}" href="{{ route('user.contact.opt-out') }}" aria-expanded="false">
                                            <span>
                                                <i class="ri-list-indefinite"></i>
                                            </span>
                                            <p>{{ translate("Opt-Out") }}</p>
                                        </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link  {{ request()->routeis('user.contact.settings.index') ? 'active' : '' }}" href="{{ route('user.contact.settings.index') }}" aria-expanded="false">
                                    <span>
                        ...
                        <div class="sub-menu-container">
                            ...
                            <ul class="sidebar-menu">
                                <li class="sidebar-menu-item">
                                    ...
                                    <div class="side-menu-dropdown collapse {{menuShow(array_merge(['user.communication.email.create', 'user.communication.email.index'], $isEmailCampaignActive))}}" id="communicationEmail">
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                        <a class="sidebar-menu-link {{request()->routeIs('user.communication.email.create')  ? 'active' :''}}" href="{{ route('user.communication.email.create') }}">
                                            <p>{{ translate("Send Email") }}</p>
                                        </a>
                                        </li>
                                        <li class="sub-menu-item">
                                        <a class="sidebar-menu-link {{request()->routeIs('user.communication.email.index')}}" href="{{ route('user.communication.email.index') }}">
                                        ...
                                        <li class="sub-menu-item">
                                            ...
                                            <ul class="sub-menu">
                                                <li class="sub-menu-item">
                                                    <a class="sidebar-menu-link {{request()->routeIs('user.communication.email.campaign.create') ? 'active' : ''}}" href="{{ route('user.communication.email.campaign.create') }}">
                                                    <p>{{ translate("Create") }}</p>
                                                    </a>
                                                </li>
                                                <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{request()->routeIs('user.communication.email.campaign.index') ? 'active' : ''}}" href="{{ route('user.communication.email.campaign.index') }}">
                                                    <p>{{ translate("List") }}</p>
                                                </a>
                                                </li>
                                            </ul>
                                ...
                                <li class="sidebar-menu-item">
                                    ...
                                    <div class="side-menu-dropdown collapse {{menuShow(array_merge(['user.communication.sms.create', 'user.communication.sms.index'], $isSmsCampaignActive))}}" id="smsCommunication">
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{request()->routeIs('user.communication.sms.create') ? 'active' :''}}" href="{{ route('user.communication.sms.create') }}">
                                                    <p>{{ translate("Send SMS") }}</p>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{request()->routeIs('user.communication.sms.index') ? 'active' : ''}}" href="{{ route('user.communication.sms.index') }}">
                                                    <p>{{ translate("History") }}</p>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                ...
                                                <div class="side-menu-dropdown collapse {{menuShow($isSmsCampaignActive)}}" id="smsCampaign" style="">
                                                  <ul class="sub-menu">
                                                    <li class="sub-menu-item">
                                                        <a class="sidebar-menu-link {{request()->routeIs('user.communication.sms.campaign.create') ? 'active' : ''}}" href="{{ route('user.communication.sms.campaign.create') }}">
                                                          <p>{{ translate("Create") }}</p>
                                                        </a>
                                                      </li>
                                                    <li class="sub-menu-item">
                                                      <a class="sidebar-menu-link {{request()->routeIs('user.communication.sms.campaign.index') ? 'active' : ''}}" href="{{ route('user.communication.sms.campaign.index') }}">
                                                        <p>{{ translate("List") }}</p>
                                                      </a>
                                                    </li>
                                                  </ul>
                                ...
                                <!--    </p>-->
                                <!--    </a>-->
                                <!--    <div class="side-menu-dropdown collapse {{menuShow(array_merge(['user.communication.whatsapp.create', 'user.communication.whatsapp.index'], $isWhatsappCampaignActive))}}" id="whatsappCommunication">-->
                                <!--        <ul class="sub-menu">-->
                                <!--            <li class="sub-menu-item">-->
                                <!--            <a class="sidebar-menu-link {{request()->routeIs('user.communication.whatsapp.create') ? 'active' :''}}" href="{{ route('user.communication.whatsapp.create') }}">-->
                                <!--                <p>{{ translate("Send Message") }}</p>-->
                                <!--            </a>-->
                                <!--            </li>-->
                                <!--            <li class="sub-menu-item">-->
                                <!--            <a class="sidebar-menu-link {{request()->routeIs('user.communication.whatsapp.index') ? 'active' :''}}" href="{{ route('user.communication.whatsapp.index') }}">-->
                                <!--                <p>{{ translate("History") }}</p>-->
                                <!--            </a>-->
                                <!--            </li>-->
                                <!--            <li class="sub-menu-item">-->
                                ...
                                <!--                <ul class="sub-menu">-->
                                <!--                    <li class="sub-menu-item">-->
                                <!--                        <a class="sidebar-menu-link {{request()->routeIs('user.communication.whatsapp.campaign.create') ? 'active' : ''}}" href="{{ route('user.communication.whatsapp.campaign.create') }}">-->
                                <!--                        <p>{{ translate("Create") }}</p>-->
                                <!--                        </a>-->
                                <!--                    </li>-->
                                <!--                    <li class="sub-menu-item">-->
                                <!--                    <a class="sidebar-menu-link {{request()->routeIs('user.communication.whatsapp.campaign.index') ? 'active' : ''}}" href="{{ route('user.communication.whatsapp.campaign.index') }}">-->
                                <!--                        <p>{{ translate("List") }}</p>-->
                                <!--                    </a>-->
                                <!--                    </li>-->
                                <!--                </ul>-->
                ...
                <li class="menu">
                    ...
                    <div class="sub-menu-wrapper {{menuShow($isTemplateActive)}}" {{ menuShow($isTemplateActive) == 'show' ? "style='opacity:1;visibility:visible;'" : '' }}>
                        <div class="sub-menu-container">
                            ...
                            <ul class="sidebar-menu">
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{ request()->routeis('user.template.email') ? 'active' : '' }}" href="{{ route('user.template.email') }}">
                                        <span>
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{ request()->routeis('user.template.sms') ? 'active' : '' }}" href="{{ route('user.template.sms') }}">
                                        <span>
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{ request()->routeis('user.template.whatsapp.index') ? 'active' : '' }}" href="{{ route('user.template.whatsapp.index') }}">
                                        <span>
                                            <i class="ri-whatsapp-line"></i>
                                        </span>
                            ...
                            <ul class="sidebar-menu">
                                <li class="sidebar-menu-item">
                                    ...
                                    <div class="side-menu-dropdown collapse {{menuShow($isReportsActive)}}" id="activityRecords">
                                        <ul class="sub-menu">
                                            ...
                                            <li class="sub-menu-item">
                                            <a class="sidebar-menu-link {{ request()->routeis('user.report.record.transaction') ? 'active' : '' }}" href="{{ route('user.report.record.transaction') }}">
                                                <p>{{ translate("Transaction History") }}</p>
                                            </a>
                                            </li>
                                            <li class="sub-menu-item">
                                            <a class="sidebar-menu-link {{ request()->routeis('user.report.record.payment') ? 'active' : '' }}" href="{{ route('user.report.record.payment') }}">
                                ...
                                <li class="sidebar-menu-item">
                                    ...
                                    <div class="side-menu-dropdown collapse {{menuShow($isCreditLogsActive)}}" id="creditLogs">
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                            <a class="sidebar-menu-link {{ request()->routeis('user.report.credit.sms') ? 'active' : '' }}" href="{{ route('user.report.credit.sms') }}">
                                                <p>{{ translate("SMS") }}</p>
                                            </a>
                                            </li>
                                            <li class="sub-menu-item">
                                            <a class="sidebar-menu-link {{ request()->routeis('user.report.credit.email') ? 'active' : '' }}" href="{{ route('user.report.credit.email') }}">
                                                <p>{{ translate("Email") }}</p>
                                            </a>
                                            </li>
                                            <li class="sub-menu-item">
                                            <a class="sidebar-menu-link {{ request()->routeis('user.report.credit.whatsapp') ? 'active' : '' }}" href="{{ route('user.report.credit.whatsapp') }}">
            ...
            <ul class="menus">
                <li class="menu">
                    <a class="menu-link {{request()->routeIs('user.support.*') ? 'active' :''}}" href="javascript:void(0)">
                        <span class="menu-symbol">
                    ...
                    <div class="sub-menu-wrapper {{menuShow(array_merge($isSupportTicketActive, ['user.support.ticket.create']))}}" {{ menuShow(array_merge($isSupportTicketActive, ['user.support.ticket.create'])) == 'show' ? "style='opacity:1;visibility:visible;'" : '' }}>
                        <div class="sub-menu-container">
                            <div class="d-flex align-items-center gap-4 mb-3 px-2 sub-menu-header">
                                <span class="back-to-menu" role="button">
                                    <i class="ri-arrow-left-line"></i>
                            ...
                            <ul class="sidebar-menu">
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{request()->routeIs('user.support.ticket.create') ? 'active' :''}}" href="{{ route('user.support.ticket.create') }}">
                                        <span>
                                ...
                                <li class="sidebar-menu-item">
                                    ...
                                    <div class="side-menu-dropdown collapse {{menuShow($isSupportTicketActive)}}" id="currency">
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{ menuActive(['user.support.ticket.index']) }}" href="{{route('user.support.ticket.index')}}">
                                                    <p>{{ translate("Ticket List") }}</p>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{ menuActive(['user.support.ticket.priority.high']) }}" href="{{route('user.support.ticket.priority.high')}}">
                                                    <p>{{ translate("High Priority") }}</p>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{ menuActive(['user.support.ticket.priority.medium']) }}" href="{{route('user.support.ticket.priority.medium')}}">
                                                    <p>{{ translate("Medium Priority") }}</p>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a class="sidebar-menu-link {{ menuActive(['user.support.ticket.priority.low']) }}" href="{{route('user.support.ticket.priority.low')}}">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{request()->routeIs('user.support.ticket.running') ? 'active' :''}}" href="{{ route('user.support.ticket.running') }}">
                                        <span>
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{request()->routeIs('user.support.ticket.answered') ? 'active' :''}}" href="{{ route('user.support.ticket.answered') }}">
                                        <span>
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{request()->routeIs('user.support.ticket.replied') ? 'active' :''}}" href="{{ route('user.support.ticket.replied') }}">
                                        <span>
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-link {{request()->routeIs('user.support.ticket.closed') ? 'active' :''}}" href="{{ route('user.support.ticket.closed') }}">
                                        <span>
